...
This project provides a clear, visual, and automated way to monitor AWS billing.  
It is part of my **Cloud Engineering & DevOps Portfolio**, demonstrating skills in:
